...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        ################################################
        # Define targets
        self.AND = np.array([0, 0, 0, 1])
        self.OR = np.array([0, 1, 1, 1])
        self.NOR = np.array([1, 0, 0, 0])
        self.NAND = np.array([1, 1, 1, 0])
        self.XOR = np.array([0, 1, 1, 0])
        self.XNOR = np.array([1, 0, 0, 1])
        ...
        self.Fitness = self.FitnessQuality
