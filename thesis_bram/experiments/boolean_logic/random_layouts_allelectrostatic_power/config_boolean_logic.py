...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        #   ---------
        #     4   5
        self.electrode_positions = np.zeros((8, 4))                                           
        self.electrode_positions[0] = [0, self.ydim/4, 0, 0]                                       
        self.electrode_positions[1] = [0, 3*self.ydim/4, 0, 0]                                     
        self.electrode_positions[2] = [self.xdim, self.ydim/4, 0, 0]                                    
        self.electrode_positions[3] = [self.xdim, 3*self.ydim/4, 0, 0]                           
        self.electrode_positions[4] = [self.xdim/4, 0, 0, 0]                                
        self.electrode_positions[5] = [3*self.xdim/4, 0, 0, 0]                              
        self.electrode_positions[6] = [self.xdim/4, self.ydim, 0, 0]                             
        self.electrode_positions[7] = [3*self.xdim/4, self.ydim, 0, 0] 

        # Define experiment
        self.generations = 100
        self.generange = [[0, 1]]*6
        self.avg = 1
        self.P = 0  # Input electrode 0
        self.Q = 1  # Input electrode 1
        self.output = 2  # Output electrode
        ...
        self.inputrange = np.array([1, 2000])*self.kT
    ...
    def FitnessCorrPower(self, x, target, P, P_max):
        '''
        P contains power of the system at each timestep/datapoint
        P_max is some upperbound for P.
        '''
        mean_power = np.mean(P)
        return (1 - mean_power/P_max) * np.corrcoef(x, target)[0, 1] 
