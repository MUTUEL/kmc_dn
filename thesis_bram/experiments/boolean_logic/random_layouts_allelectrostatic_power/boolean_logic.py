...
maxpower = cf.controlrange[1]*0.5
    ...
    for j in range(cf.genomes):
        ...
        for k in range(4):
            ...
            for l in range(cf.avg):
                ...
                power[k*cf.avg + l] = np.abs(kmc.current[1] * kmc.electrodes[1, 3])
        outputArray[i, j] = output
        fitness_list.append(cf.Fitness(output, cf.target, power, maxpower))
