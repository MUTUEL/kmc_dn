...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        ################################################
        # Gene to test
        self.gene = [0.46885573 ,0.74812522 ,0.27036912 ,0.35819929 ,0.46544222]
        self.allzero = True  # Set this to true for setting all electrodes zero
        self.sweep_electrode = 7
        ...
        self.voltagerange = np.array([-1000, 1000])*self.kT

        # Create voltagelist
        self.voltagelist = np.linspace(self.voltagerange[0], 
                                       self.voltagerange[1],
                                       self.n_voltage)
        ...
        self.name = f'sweep_electrode_{self.sweep_electrode}'
